    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{url('/')}}" class="brand-link">
                <img src="{{asset('template/theme/images/LOGO SMPN 1 OK.png')}}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">SMP N 1 MuaroJambi</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021 <a href="#">XadeXGroup</a>.</strong>
            All rights reserved.
...
<script>
    ...
    $(function () {
        ...
        $('#quickForm').validate({
            ...
            messages: {
                avatar: {
                    // filesize:"Ukuran file harus dibawah 500 KB.",
