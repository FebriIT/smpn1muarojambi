...
<div class="content-wrapper">
                    ...
                    <td class="project-actions text-right">
                      <div>
                        ...
                        <a class="btn btn-info btn-sm" href="#" data-toggle="modal"
                          data-target="#editModal-{{$datas->kategori_id}}">
                          <i class="fas fa-pencil-alt">
                          </i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-sm"
                          href="/{{auth()->user()->role}}/kategori/{{$datas->kategori_id}}/hapus"
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/{{auth()->user()->role}}/kategori/tambah" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group">
              <label for="judul">Kategori</label>
              <input type="text" name="kategori_nama" value="{{ old('kategori_nama')}}" class="form-control" id="judul"
  ...
  {{-- Modal edit Data --}}
  @foreach ($data as $feb)
  <div class="modal fade" id="editModal-{{$feb->kategori_id}}">
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="/{{auth()->user()->role}}/kategori/{{$feb->kategori_id}}/edit" method="POST"
            ...
            <div class="form-group">
              <label for="judul">Kategori</label>
              <input type="text" value="{{$feb->kategori_nama}}" name="kategori_nama" id="judul" class="form-control">
