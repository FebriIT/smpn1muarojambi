                                        ...
                                        <td class="project-actions text-right">
                                            <div>
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    href="/{{auth()->user()->role}}/mapel/{{$datas->id}}/hapus"
                ...
                <div class="modal-body">
                    <form action="/{{auth()->user()->role}}/mapel/tambah" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mapel_nama" value="{{ old('mapel_nama')}}" class="form-control"
                                id="mapel" placeholder="Kategori" required>
    ...
    <div class="modal fade" id="editModal-{{$feb->id}}">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/{{auth()->user()->role}}/mapel/{{$feb->id}}/edit" method="POST"
