...
<!-- Main content -->
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="/{{auth()->user()->role}}/postberita/tambah" method="POST" enctype="multipart/form-data" >
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-12">
                        <div class="card card-outline card-danger">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <input type="text" name="berita_judul" required class="form-control rounded-0" id="exampleInputRounded0" placeholder="Judul Berita atau Artikel" required>
                                            @if ($errors->any('berita_judul'))
                                                <p style="color: #dc3545; font-size:13px"><i>*{{$errors->first('berita_judul')}}</i></p>
                                            @endif
                                        </div>
                                        <div class="col-md-2">
                                            <button type="submit" class="btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Publish</button>
                                        </div>
                                    </div>   
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="exampleInputFile" name="berita_gambar" required>
