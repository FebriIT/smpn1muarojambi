                        ...
                        <div class="card card-outline card-danger">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <input type="text" name="berita_judul" value="{{ $data->berita_judul }}"
                                                required class="form-control rounded-0" id="exampleInputRounded0"
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" class="btn-sm btn-primary float-right"><i
                                                    class="fas fa-pencil-alt nav-icon"></i> Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
